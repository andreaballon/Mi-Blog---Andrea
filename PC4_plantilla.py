...
st.markdown("<h1 style='text-align: center;'>Hola, soy Andrea⭐</h1>", unsafe_allow_html=True)
...
col1.image("andrea.jpeg", caption='Andrea, 22 años (2024)', width=300)
...
texto = """
Mi nombre completo es Andrea Ariana Ballón Rodríguez. Nací el 19 de abril de 2002. Soy aries. 
Estudio Comunicación Audiovisual en la Pontificia Universidad Católica del Perú y, a la par, soy bailarina de danza urbana. 
Me encanta escuchar música. Mis estilos favoritos son el hip hop, el r&b y el pop.
Además, me gusta ver películas y series. Mis géneros favoritos son el policial y la aventura. Asimismo, leer es otro de mis pasatiempos favoritos.
"""
...
texto_2 = """
Programar fue una experiencia interesante. Al principio, era un poco complicado memorizar los códigos y las funciones. Además, muchas de las actividades que nos dejaban en las PCS no lograba comprenderlas del todo. Sin embargo, con la ayuds de mi JP y el profesor aprendí muchísimo.
"""
...
if grafico_seleccionado == 'Goles Roma':
    ...
    sidebar.markdown("<div style='text-align: justify'>Se tratan de dos gráficos de barras de los goles anotados por Milan tanto como equipo local como equipo visitante.</div>", unsafe_allow_html=True)
    sidebar.image("goles_milan.png", caption='Goles Milan', width=500)
    pass
elif grafico_seleccionado == 'Mapa Familias':
    sidebar.markdown("<div style='text-align: justify'>Se observa la familia linguistica Tupian en Sudamérica.</div>", unsafe_allow_html=True)
